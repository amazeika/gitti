...
var eN = LanguageMapping{
	...
	FlagCommitLogShowRefs:               "Set whether the Commit Log shows the branch, tag and HEAD refs pointing at each commit: 'true' to show them, 'false' to hide them. Default is true",
	FlagCommitLogShowAllBranches:        "Set whether the Commit Log shows commits from every local branch, remote-tracking branch and tag: 'true' to show them, 'false' to show only the current branch. Default is false",
	...
	CommitLogShowRefsEnabled:            "Commit log ref decorations enabled",
	CommitLogShowRefsDisabled:           "Commit log ref decorations disabled",
	CommitLogShowRefsSetError:           "Invalid input, please enter `true` to show commit log ref decorations or `false` to hide them",
	CommitLogShowRefsSaveError:          "Failed to save the commit log ref setting: %s",
	CommitLogShowAllBranchesEnabled:     "All-branches commit log enabled",
	CommitLogShowAllBranchesDisabled:    "All-branches commit log disabled",
	CommitLogShowAllBranchesSetError:    "Invalid input, please enter `true` to show commits from every branch or `false` to show only the current branch",
	CommitLogShowAllBranchesSaveError:   "Failed to save the all-branches commit log setting: %s",
	Branches:                            "Branches",
	...
	ScreenModeNavigationDescription:     "screen mode",
	...
	GitPushPopUpWorkingDirectory:                                   "Working directory",
	GitPushPopUpArgv:                                               "argv",
	GitPushPopUpExitStatus:                                         "Exit status",
	GitPushPopUpExitStatusNotStarted:                               "not started",
	GitPushPopUpExitStatusCancelled:                                "cancelled",
	GitPushPopUpCouldNotStart:                                      "Push could not be started: %s",
	GitPushPopUpNonZeroExit:                                        "Push failed with exit status %d. Check the output above for the reason.",
	GitPushPopUpReadFailure:                                        "Push finished with exit status 0 but its output could not be captured completely: %s",
	GitPushPopUpStdout:                                             "stdout",
	GitPushPopUpStderr:                                             "stderr",
	GitPushPopUpStreamEmpty:                                        "(no output)",
	GitPushPopUpReconciling:                                        "Refreshing repository state",
	GitPushPopUpPushSucceeded:                                      "Push succeeded.",
	GitPushPopUpRefreshSucceeded:                                   "Push succeeded and the repository state was reconciled.",
	GitPushPopUpRefreshFailed:                                      "The post-push state refresh failed: %s. The last good state is kept.",
