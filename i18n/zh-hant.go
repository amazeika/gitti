...
var zH_HANT = LanguageMapping{
	...
	FlagCommitLogShowRefs:               "設定提交日誌是否顯示指向每個提交的分支、標籤與 HEAD 參考：'true' 表示顯示，'false' 表示隱藏。預設值為 true",
	FlagCommitLogShowAllBranches:        "設定提交日誌是否顯示所有本機分支、遠端追蹤分支與標籤的提交：'true' 表示顯示，'false' 表示僅顯示目前分支。預設值為 false",
	...
	CommitLogShowRefsEnabled:            "提交日誌參考顯示已啟用",
	CommitLogShowRefsDisabled:           "提交日誌參考顯示已停用",
	CommitLogShowRefsSetError:           "輸入無效，請輸入 `true` 以顯示提交日誌參考，或輸入 `false` 以隱藏參考",
	CommitLogShowRefsSaveError:          "無法儲存提交日誌參考設定：%s",
	CommitLogShowAllBranchesEnabled:     "全分支提交日誌已啟用",
	CommitLogShowAllBranchesDisabled:    "全分支提交日誌已停用",
	CommitLogShowAllBranchesSetError:    "輸入無效，請輸入 `true` 以顯示所有分支的提交，或輸入 `false` 以僅顯示目前分支",
	CommitLogShowAllBranchesSaveError:   "無法儲存全分支提交日誌設定：%s",
	Branches:                            "分支",
	...
	ScreenModeNavigationDescription:     "螢幕模式",
	...
	GitPushPopUpWorkingDirectory:                                   "工作目錄",
	GitPushPopUpArgv:                                               "argv",
	GitPushPopUpExitStatus:                                         "退出狀態",
	GitPushPopUpExitStatusNotStarted:                               "未啟動",
	GitPushPopUpExitStatusCancelled:                                "已取消",
	GitPushPopUpCouldNotStart:                                      "無法啟動推送: %s",
	GitPushPopUpNonZeroExit:                                        "推送失敗,退出狀態為 %d。請檢查上方輸出以了解原因。",
	GitPushPopUpReadFailure:                                        "推送以退出狀態 0 結束,但無法完整捕獲其輸出: %s",
	GitPushPopUpStdout:                                             "stdout",
	GitPushPopUpStderr:                                             "stderr",
	GitPushPopUpStreamEmpty:                                        "(無輸出)",
	GitPushPopUpReconciling:                                        "正在更新儲存庫狀態",
	GitPushPopUpPushSucceeded:                                      "推送成功。",
	GitPushPopUpRefreshSucceeded:                                   "推送成功,且儲存庫狀態已核對。",
	GitPushPopUpRefreshFailed:                                      "推送後的狀態刷新失敗: %s。已保留最後的有效狀態。",
