...
var zH_HANS = LanguageMapping{
	...
	FlagCommitLogShowRefs:               "设置提交日志是否显示指向每个提交的分支、标签和 HEAD 引用：'true' 表示显示，'false' 表示隐藏。默认值为 true",
	FlagCommitLogShowAllBranches:        "设置提交日志是否显示所有本地分支、远程跟踪分支和标签的提交：'true' 表示显示，'false' 表示仅显示当前分支。默认值为 false",
	...
	CommitLogShowRefsEnabled:            "提交日志引用显示已启用",
	CommitLogShowRefsDisabled:           "提交日志引用显示已禁用",
	CommitLogShowRefsSetError:           "输入无效，请输入 `true` 以显示提交日志引用，或输入 `false` 以隐藏引用",
	CommitLogShowRefsSaveError:          "无法保存提交日志引用设置：%s",
	CommitLogShowAllBranchesEnabled:     "全分支提交日志已启用",
	CommitLogShowAllBranchesDisabled:    "全分支提交日志已禁用",
	CommitLogShowAllBranchesSetError:    "输入无效，请输入 `true` 以显示所有分支的提交，或输入 `false` 以仅显示当前分支",
	CommitLogShowAllBranchesSaveError:   "无法保存全分支提交日志设置：%s",
	Branches:                            "分支",
	...
	ScreenModeNavigationDescription:     "屏幕模式",
	...
	GitPushPopUpWorkingDirectory:                                   "工作目录",
	GitPushPopUpArgv:                                               "argv",
	GitPushPopUpExitStatus:                                         "退出状态",
	GitPushPopUpExitStatusNotStarted:                               "未启动",
	GitPushPopUpExitStatusCancelled:                                "已取消",
	GitPushPopUpCouldNotStart:                                      "无法启动推送: %s",
	GitPushPopUpNonZeroExit:                                        "推送失败,退出状态为 %d。请检查上方输出以了解原因。",
	GitPushPopUpReadFailure:                                        "推送以退出状态 0 结束,但无法完整捕获其输出: %s",
	GitPushPopUpStdout:                                             "stdout",
	GitPushPopUpStderr:                                             "stderr",
	GitPushPopUpStreamEmpty:                                        "(无输出)",
	GitPushPopUpReconciling:                                        "正在刷新仓库状态",
	GitPushPopUpPushSucceeded:                                      "推送成功。",
	GitPushPopUpRefreshSucceeded:                                   "推送成功,且仓库状态已核对。",
	GitPushPopUpRefreshFailed:                                      "推送后的状态刷新失败: %s。已保留最后的有效状态。",
